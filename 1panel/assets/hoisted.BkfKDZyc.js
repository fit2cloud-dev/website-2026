import"./hoisted.-yj-PjOU.js";(function(){if(window.self===window.top||window.__iframeHighlightInitialized)return;window.__iframeHighlightInitialized=!0,console.log("Iframe 高亮脚本已加载");var r=document.createElement("div");r.id="iframe-highlight-overlay",r.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    width: 100vw;
